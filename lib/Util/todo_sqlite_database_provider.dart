...
class TodoSQLiteDatabaseProvider{
  ...
  static TodoSQLiteDatabaseProvider getDatabaseProvider() => databaseProvider; //databaseProvider 반환 함수

  Future<Database> _getDatabase() async {
    return _database ??= await _initDatabase(); //null인 경우 _initDatabase()의 반환값을 _database에 저장하고 반환
  }

  Future<Database> _initDatabase() async { //DB 초기화
